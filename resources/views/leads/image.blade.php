...
<style>
    ...
    @media (max-width: 900px) {
        .image-meta { grid-template-columns: repeat(2, minmax(0, 1fr)); }
    }

    @media (max-width: 700px) {
        .image-view-page { padding: 14px; }
        .image-header { align-items: flex-start; flex-direction: column; padding: 18px; }
        .image-actions, .image-actions .image-btn { width: 100%; }
        .image-stage { padding: 16px; min-height: 420px; }
        .image-frame { min-height: 360px; }
        .image-meta { grid-template-columns: 1fr; padding: 0 16px 16px; }
    }
</style>
